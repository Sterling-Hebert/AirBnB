...
- Request
  ...
  - Method: post
  - URL: /reservations/:id/reviews/:id/images/
  - Headers:
    - Content-Type: application/json
  - Body:
...
- Request
  ...
  - Method: POST
  - URL: /account/hosting/:id/openings/
  - Body:
...
- Request
  ...
  - Method: DELETE
  - URL: /account/hosting/:id/images/:id/delete
  - Body: none
...
- Request
  ...
  - Method: delete
  - URL: /account/reviews/:id/images/:id/delete
  - Body: none
...
- Error Response: Query parameter validation errors
  ...
  - Body:
    ...
    ![image](https://user-images.githubusercontent.com/60053292/216201832-acae49e5-841f-4360-8e6b-089d79f46549.png)
