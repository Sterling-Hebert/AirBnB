...
router.get("/", async (req, res) => {
  ...
  const spots = await Spot.scope("reviewCurrentUserScope").findAll({
    where: {
...
router.post("/:id/reviews", requireAuth, reviewValidation, async (req, res) => {
